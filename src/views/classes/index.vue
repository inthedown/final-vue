<template>
  ...
  >
    ...
    <template #toolbar>
      <el-button type="primary" @click="importStu()"> 导入学生 </el-button>
      <el-button type="primary" @click="importCouse()"> 导入课程 </el-button>
    ...
    <template #operate="{ row }">
      <el-button size="mini" @click="getDetail(row.id)"> 详情 </el-button>
      <el-button
        type="primary"
        size="mini"
  ...
  <el-dialog
    title="导入课程"
    v-model="dialogImportCouVisible"
    :before-close="handleClose"
  >
    <import-cou
      :id="selectItem.id"
      :className="selectItem.className"
      @close="dialogImportCouVisible = false"
    ></import-cou>
  </el-dialog>
</template>
